...
) : AdapterDelegate<HorizontalItem<TeaserRenderer>, HorisontalTeaserViewHolder> {

    override fun onBindViewHolder(vh: HorisontalTeaserViewHolder,
                                  item: HorizontalItem<TeaserRenderer>) {
        item.render(vh)
    }

    override fun onCreateViewHolder(parent: ViewGroup): RecycableViewHolder {
        return HorisontalTeaserViewHolder(inflater.inflate(R.layout.teaser_item_layout, parent, false))
    }
